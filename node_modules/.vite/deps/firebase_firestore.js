...
async function __PRIVATE_eventManagerListen(e, t) {
  ...
  if (n.queries.set(r2, s), s.Q_.push(t), t.U_(n.onlineState), s.q_) {
...
var __PRIVATE_SyncEngineImpl = class {
  constructor(e, t, n, r2, i, s) {
    this.localStore = e, this.remoteStore = t, this.eventManager = n, this.sharedClientState = r2, this.currentUser = i, this.maxConcurrentLimboResolutions = s, this.fa = {}, this.ga = new ObjectMap((e2) => __PRIVATE_canonifyQuery(e2), __PRIVATE_queryEquals), this.pa = /* @__PURE__ */ new Map(), this.ya = /* @__PURE__ */ new Set(), this.wa = new SortedMap(DocumentKey.comparator), this.Sa = /* @__PURE__ */ new Map(), this.ba = new __PRIVATE_ReferenceSet(), this.Da = {}, this.Ca = /* @__PURE__ */ new Map(), this.va = __PRIVATE_TargetIdGenerator.Bn(), this.onlineState = "Unknown", this.Fa = void 0;
  }
  get isPrimaryClient() {
    return true === this.Fa;
  }
...
var __PRIVATE_TransactionRunner = class {
  constructor(e, t, n, r2, i) {
    this.asyncQueue = e, this.datastore = t, this.options = n, this.updateFunction = r2, this.deferred = i, this.za = n.maxAttempts, this.jo = new __PRIVATE_ExponentialBackoff(this.asyncQueue, "transaction_retry");
  }
  ja() {
    this.za -= 1, this.Ha();
  }
...
var __PRIVATE_ParseContextImpl = class {
  constructor(e, t, n, r2, i, s) {
    this.settings = e, this.databaseId = t, this.serializer = n, this.ignoreUndefinedProperties = r2, void 0 === i && this.Eu(), this.fieldTransforms = i || [], this.fieldMask = s || [];
  }
  get path() {
...
!function __PRIVATE_registerFirestore(e, t = true) {
  ...
  }, "PUBLIC").setMultipleInstances(true)), registerVersion(w2, "4.4.3", e), registerVersion(w2, "4.4.3", "esm2017");
}();
export {
